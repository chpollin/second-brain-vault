...
status: draft
query-topics: [agents, rules, constitution, rule-tiers, convention-index]
---
...
This file is generated from [[CLAUDE]] and carries the same rules for agents that do not read a CLAUDE.md. Never edit it by hand. Change [[CLAUDE]] and run `python scripts/render_agents_md.py`.
